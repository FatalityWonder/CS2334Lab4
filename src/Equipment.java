...
public class Equipment
{
    ...
    public boolean equals(Object other)
    {
        ...
        if (this.getCount() == (otherEq.getCount()) &&
        	this.getName().equals(otherEq.getName()) &&
        	this.getTotalWeight() == otherEq.getTotalWeight() &&
        	this.getTotalPrice() == otherEq.getTotalPrice() &&
        	this.getDescription().equals(otherEq.getDescription()))
        {
        	return true;
        }
